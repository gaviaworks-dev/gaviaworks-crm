...
DB.referrers = [
  { kod:'REF-001', ad:'Hakan Demirtaş', tur:'Mevcut müşteri', firma:'Deniz Lojistik A.Ş.', pozisyon:'Bilgi İşlem Müdürü',
    ...
    komisyonModeli:'Ciro yüzdesi', komisyonOrani:5, sabitBedel:0, hakedis:87000, odenen:52000, bekleyen:35000,
  ...
  { kod:'REF-002', ad:'Ayten Berk', tur:'İş ortağı', firma:'Berk Danışmanlık', pozisyon:'Kurucu',
    ...
    yonlendirme:4, kazanilan:2, kaybedilen:1, ciro:960000, donusum:50, sonYonlendirme:'2026-07-29',
  ...
  { kod:'REF-004', ad:'Serdar Kılıç', tur:'Eski müşteri', firma:'Kılıç Tekstil', pozisyon:'Genel Müdür',
    ...
    yonlendirme:3, kazanilan:1, kaybedilen:2, ciro:380000, donusum:33, sonYonlendirme:'2026-05-14',
  ...
  { kod:'REF-006', ad:'Linkedin Kampanyası', tur:'Dijital reklam', firma:'—', pozisyon:'—',
    ...
    yonlendirme:8, kazanilan:1, kaybedilen:5, ciro:180000, donusum:13, sonYonlendirme:'2026-07-22',
    komisyonModeli:'Yok', komisyonOrani:0, sabitBedel:0, hakedis:0, odenen:0, bekleyen:0,
  ...
  { kod:'REF-007', ad:'Murat Sezer', tur:'Danışman', firma:'Sezer Yönetim Danışmanlığı', pozisyon:'Yönetici Ortak',
    ...
    yonlendirme:2, kazanilan:1, kaybedilen:0, ciro:680000, donusum:50, sonYonlendirme:'2026-07-08',
...
DB.customers = [
  { kod:'MUS-2024-001', unvan:'Deniz Lojistik A.Ş.', kisa:'Deniz Lojistik', sektor:'Lojistik', buyukluk:'250-500',
    durum:'Aktif', risk:'Düşük', sorumlu:'EMP-002', kaynak:'Referans', referans:'REF-003',
    ...
    projeSayisi:3, aktifProje:1, toplamCiro:2180000, bekleyenTahsilat:145000, memnuniyet:4.6, aktif:true,
  ...
  { kod:'MUS-2024-002', unvan:'Vitalis Sağlık Grubu', kisa:'Vitalis Sağlık', sektor:'Sağlık', buyukluk:'100-250',
    durum:'Aktif', risk:'Orta', sorumlu:'EMP-002', kaynak:'Referans', referans:'REF-002',
    ...
    projeSayisi:2, aktifProje:2, toplamCiro:1480000, bekleyenTahsilat:320000, memnuniyet:4.1, aktif:true,
  ...
  { kod:'MUS-2025-003', unvan:'Anadolu Perakende Ticaret Ltd.', kisa:'Anadolu Perakende', sektor:'Perakende', buyukluk:'50-100',
    durum:'Aktif', risk:'Yüksek', sorumlu:'EMP-014', kaynak:'Web formu', referans:'REF-005',
    ...
    projeSayisi:2, aktifProje:1, toplamCiro:760000, bekleyenTahsilat:285000, memnuniyet:2.9, aktif:true,
    etiketler:['Riskli','Geciken ödeme'] },
  { kod:'MUS-2025-004', unvan:'Ege Eğitim Kurumları', kisa:'Ege Eğitim', sektor:'Eğitim', buyukluk:'100-250',
    durum:'Aktif', risk:'Düşük', sorumlu:'EMP-002', kaynak:'Referans', referans:'REF-001',
  ...
  { kod:'MUS-2025-005', unvan:'Marmara Enerji Sistemleri', kisa:'Marmara Enerji', sektor:'Enerji', buyukluk:'500+',
    ...
    projeSayisi:1, aktifProje:1, toplamCiro:980000, bekleyenTahsilat:196000, memnuniyet:4.4, aktif:true,
  ...
  { kod:'MUS-2026-007', unvan:'Nova Turizm Yatırımları', kisa:'Nova Turizm', sektor:'Turizm', buyukluk:'50-100',
    durum:'Aktif', risk:'Düşük', sorumlu:'EMP-014', kaynak:'Sosyal medya', referans:'REF-006',
    ...
    projeSayisi:1, aktifProje:1, toplamCiro:420000, bekleyenTahsilat:84000, memnuniyet:4.2, aktif:true,
    etiketler:['Turizm','Rezervasyon'] },
  { kod:'MUS-2026-008', unvan:'Başkent Hukuk Bürosu', kisa:'Başkent Hukuk', sektor:'Hukuk', buyukluk:'10-50',
    durum:'Potansiyel', risk:'Düşük', sorumlu:'EMP-014', kaynak:'Referans', referans:'REF-002',
  ...
  { kod:'MUS-2026-009', unvan:'Öz Gıda Üretim A.Ş.', kisa:'Öz Gıda', sektor:'Gıda', buyukluk:'250-500',
    durum:'Aktif', risk:'Orta', sorumlu:'EMP-002', kaynak:'Etkinlik', referans:'REF-008',
    ...
    projeSayisi:1, aktifProje:1, toplamCiro:295000, bekleyenTahsilat:59000, memnuniyet:4.0, aktif:true,
  ...
  { kod:'MUS-2026-010', unvan:'Trakya Otomotiv Servis', kisa:'Trakya Otomotiv', sektor:'Otomotiv', buyukluk:'10-50',
    ...
    projeSayisi:1, aktifProje:1, toplamCiro:185000, bekleyenTahsilat:92500, memnuniyet:2.4, aktif:true,
  ...
  { kod:'MUS-2026-011', unvan:'Anka Finans Teknolojileri', kisa:'Anka Finans', sektor:'Finans', buyukluk:'50-100',
    ...
    projeSayisi:1, aktifProje:1, toplamCiro:530000, bekleyenTahsilat:0, memnuniyet:4.7, aktif:true,
  ...
  { kod:'MUS-2023-012', unvan:'Karadeniz Tarım Kooperatifi', kisa:'Karadeniz Tarım', sektor:'Tarım', buyukluk:'10-50',
    ...
    adres:'Ortahisar, Trabzon', vergiNo:'6community', vergiDairesi:'Ortahisar',
...
DB.leads = [
  { kod:'LEAD-2026-001', firma:'Başkent Hukuk Bürosu', yetkili:'Av. Selçuk Onaran', tel:'+90 312 000 00 17', eposta:'iletisim@baskenthukuk.av.tr',
    ...
    talepTarihi:'2026-06-15', kaynak:'Referans', referans:'REF-002', yonlendiren:'Ayten Berk', sorumlu:'EMP-014',
  ...
  { kod:'LEAD-2026-002', firma:'Ege Eğitim Kurumları', yetkili:'Neslihan Öz', tel:'+90 232 000 00 13', eposta:'bilgi@egeegitim.k12.tr',
    ...
    talepTarihi:'2026-07-02', kaynak:'Referans', referans:'REF-001', yonlendiren:'Hakan Demirtaş', sorumlu:'EMP-002',
  ...
  { kod:'LEAD-2026-009', firma:'Doğu Turizm Acentesi', yetkili:'Melis Aydoğan', tel:'+90 242 000 00 44', eposta:'melis@doguturizm.com',
    ...
    talepTarihi:'2026-07-26', kaynak:'Sosyal medya', referans:'REF-006', yonlendiren:'Linkedin Kampanyası', sorumlu:'EMP-014',
  ...
  { kod:'LEAD-2026-011', firma:'Akdeniz Klinik Grubu', yetkili:'Dr. Sinan Bora', tel:'+90 242 000 00 46', eposta:'sinan@akdenizklinik.com',
    ...
    talepTarihi:'2026-08-02', kaynak:'Referans', referans:'REF-001', yonlendiren:'Hakan Demirtaş', sorumlu:'EMP-002',
